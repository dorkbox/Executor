...
project.description = 'Shell and JVM command execution on Linux, MacOS, or Windows for Java 6+'
project.group = 'com.dorkbox'
project.version = '1.1'

project.ext.name = 'ShellExecutor'
project.ext.url = 'https://git.dorkbox.com/dorkbox/ShellExecutor'
