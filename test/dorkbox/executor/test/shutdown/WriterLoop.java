...
class WriterLoop {
    ...
    public static File getFile() {
        return new File("writeLoop.data").getAbsoluteFile();
    }

    public static void main(String[] args) throws Exception {
        System.out.println("Starting output to " + getFile());

        PrintWriter out = new PrintWriter(new FileWriter(getFile()), true);
